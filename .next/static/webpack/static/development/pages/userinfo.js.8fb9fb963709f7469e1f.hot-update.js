...
function (_React$Component) {
  ...
  _createClass(UserInfo, [{
    ...
    value: function saveUserInfoAction() {
      ...
      var tokenStr = userInfo.token;
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.post("http://ec2-52-15-224-200.us-east-2.compute.amazonaws.com:8080/api/users/editprofile?userName=" + username + "&Identity=" + Identity + "&Bio=" + Bio + "&Position=" + Position + "&Institution=" + Institution, {}, {
        headers: {
          'Content-Type': 'application/json',
          "Authorization": "Bearer " + tokenStr
        }
...
//# sourceMappingURL=userinfo.js.8fb9fb963709f7469e1f.hot-update.js.map